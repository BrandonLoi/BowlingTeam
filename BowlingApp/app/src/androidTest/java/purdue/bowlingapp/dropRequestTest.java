    ...
    public void userCreateTest() {
        ...
        ValueEventListener listen = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                boolean x = dataSnapshot.child("messages").child("testUser").child("req").child("drop").child("GROUP").hasChild("testUser2");
        ...
        DatabaseReference myRef6 = mDatabase.child("messages").child("testUser").child("req").child("drop").child("GROUP").child("testUser2");
