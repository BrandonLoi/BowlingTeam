    ...
    public void endTournamentTest() {
        ...
        liveTournament.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                tournamentRef.child("singleLeft").setValue("-1");
                tournamentRef.child("singleMade").setValue("-1");
                tournamentRef.child("splitLeft").setValue("-1");
                tournamentRef.child("splitMade").setValue("-1");
                tournamentRef.child("multiLeft").setValue("-1");
                tournamentRef.child("multiMade").setValue("-1");
                tournamentRef.child("numStrikes").setValue("-1");
                tournamentRef.child("cumulativeScore").setValue("-1");
                tournamentRef.child("numGames").setValue("-1");
                tournamentRef.child("ballsThrown").setValue("-1");
                tournamentRef.child("filledFrames").setValue("-1");
