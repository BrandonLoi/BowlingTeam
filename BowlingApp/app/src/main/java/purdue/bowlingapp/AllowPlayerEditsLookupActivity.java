...
public class AllowPlayerEditsLookupActivity extends AppCompatActivity {
                    ...
                    usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.hasChild(usernameLookUp)) {
                                Intent i = new Intent(AllowPlayerEditsLookupActivity.this,
                                        AllowPlayerEditsActivity.class);
                            ...
                            for (DataSnapshot user : dataSnapshot.getChildren()) {
                                if (user.hasChild("email")) {
                                    if (user.child("email").getValue().toString().equals(email)) {
                                        i = new Intent(AllowPlayerEditsLookupActivity.this,
                                                AllowPlayerEditsActivity.class);
