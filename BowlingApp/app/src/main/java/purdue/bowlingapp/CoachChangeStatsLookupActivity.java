...
public class CoachChangeStatsLookupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coach_change_stats_lookup);
                    ...
                    usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.hasChild(usernameLookUp)) {
                                Intent i = new Intent(CoachChangeStatsLookupActivity.this,
                                        CoachChangeStatsActivity.class);
                            ...
                            for (DataSnapshot user : dataSnapshot.getChildren()) {
                                if (user.hasChild("email")) {
                                    if (user.child("email").getValue().toString().equals(email)) {
                                        i = new Intent(CoachChangeStatsLookupActivity.this,
                                                CoachChangeStatsActivity.class);
